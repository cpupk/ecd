...
public class ByteCodeDocument extends Document
{
	...
	public ByteCodeDocument( ByteCodeDocumentProvider documentProvider, JavaDecompilerClassFileEditor editor )
	{
		super( );
	...
	public ByteCodeDocumentProvider getDocumentProvider( )
	{
